        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-heading font-bold text-xl">Zia Chohan</span>
            </div>
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Your trusted partner for 24/7 mobile tyre services across Dubai. Fast response, expert technicians, and honest pricing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+971501234567" className="text-sm hover:text-accent transition-colors">
                    +971 50 123 4567
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@ziachohan.ae" className="text-sm text-primary-foreground/70 hover:text-accent transition-colors">
                  info@ziachohan.ae
                </a>
              </li>
              <li className="flex items-start gap-3">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-primary-foreground/60">
            © {new Date().getFullYear()} Zia Chohan Mobile Tyre Services. All rights reserved.
          </p>
